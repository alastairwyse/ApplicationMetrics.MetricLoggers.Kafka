...
{
    /// <summary>
    /// An instance of a <see cref="StatusMetric"/>
    /// </summary>
    public class StatusMetricInstance : MetricInstanceBase
    {
        /// <summary>The value of the metric.</summary>
        public Int64 Value { get; }

        /// <summary>
        /// Initialises a new instance of the ApplicationMetrics.MetricLoggers.Kafka.Models.StatusMetricInstance class.
        /// </summary>
        ...
        public StatusMetricInstance(String typeFullName, String name, String description, DateTime eventTime, Int64 value)
        ...
        /// <param name="eventTime">The timestamp when the metric occurred.</param>
        /// <param name="value">The value of the metric.</param>
        public StatusMetricInstance(String typeFullName, String category, String name, String description, DateTime eventTime, Int64 value)
