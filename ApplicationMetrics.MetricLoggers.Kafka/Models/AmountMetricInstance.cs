...
{
    /// <summary>
    /// An instance of an <see cref="AmountMetric"/>
    /// </summary>
    public class AmountMetricInstance : MetricInstanceBase
    {
        /// <summary>The amount of the metric.</summary>
        public Int64 Amount { get; }

        /// <summary>
        /// Initialises a new instance of the ApplicationMetrics.MetricLoggers.Kafka.Models.AmountMetricInstance class.
        /// </summary>
        ...
        /// <param name="amount">The amount of the metric.</param>
        public AmountMetricInstance(String typeFullName, String name, String description, DateTime eventTime, Int64 amount)
        ...
        /// <param name="eventTime">The timestamp when the metric occurred.</param>
        /// <param name="amount">The amount of the metric.</param>
        public AmountMetricInstance(String typeFullName, String category, String name, String description, DateTime eventTime, Int64 amount)
