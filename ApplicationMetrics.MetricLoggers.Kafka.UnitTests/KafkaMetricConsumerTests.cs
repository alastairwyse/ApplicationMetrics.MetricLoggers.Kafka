...
namespace ApplicationMetrics.MetricLoggers.Kafka.UnitTests
{
    ...
    public class KafkaMetricConsumerTests
    {
        ...
        public void Constructor_TopicParameterNull()
        {
            ...
            {
                var testKafkaMetricConsumer = new KafkaMetricConsumer(null, testBootstrapServers);
            });
            ...
            {
                var testKafkaMetricConsumer = new KafkaMetricConsumer(null, new ConsumerConfig());
            });
        ...
        public void Constructor_TopicParameterWhitespace()
        {
            var e = Assert.Throws<ArgumentException>(delegate
            {
                var testKafkaMetricConsumer = new KafkaMetricConsumer(" ", testBootstrapServers);
            });
            ...
            e = Assert.Throws<ArgumentException>(delegate
            {
                var testKafkaMetricConsumer = new KafkaMetricConsumer(" ", new ConsumerConfig());
            });
